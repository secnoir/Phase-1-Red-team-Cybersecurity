Python can be used to read files and also write to files.When we want to perform read and write in python we typically have 3 modes which we can use. read(r) , Write(w) , Append(a).
